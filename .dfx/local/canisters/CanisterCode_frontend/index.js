...
import { idlFactory } from './CanisterCode_frontend.did.js';
export { idlFactory } from './CanisterCode_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTERCODE_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./CanisterCode_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the CanisterCode_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./CanisterCode_frontend.did.js")._SERVICE>}
 */
export const CanisterCode_frontend = createActor(canisterId);
